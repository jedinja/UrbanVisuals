...
public class Component_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "Component", new SNodePointer("r:914e5cb2-4cd8-4b33-8a43-c050bdeef788(UrbanVisuals.editor)", "2626510300427990054")));
    try {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new Component_TransformationMenu.TMP_IncludeSM_reuycl_a0());
    }
    return result;
  }

  public class TMP_IncludeSM_reuycl_a0 extends IncludeSubstituteMenuTransformationMenuPart {
    @NotNull
    @Override
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      ...
      try {
        ...
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("include substitute menu " + "default substitute menu for " + "Component", new SNodePointer("r:914e5cb2-4cd8-4b33-8a43-c050bdeef788(UrbanVisuals.editor)", "2626510300428255227")));
